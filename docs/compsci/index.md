...
| 1/10/10 | кодира податке и UNICODE кодовима; процени количину меморије коју заузимају различити типови података     | Представљање података у меморији      | ОЛ  |
...
| 3/30/2  | користи функционалности намењене сарадничком раду                                                       | Сараднички рад онлајн                              | ОЛ  |
